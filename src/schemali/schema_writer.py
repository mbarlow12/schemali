...
from schemali.parse import models_json_schema_

from .generator import SchemaliGenerateJsonSchema
...
class SchemaWriter:
    ...
    def write_consolidated_schema(
        ...
        model_args = [(m, "validation") for m in models]
        _, schema = models_json_schema_(models=model_args, base_uri=base_uri)
